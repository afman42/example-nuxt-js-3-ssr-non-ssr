...
const styles = {
  ...
  "layouts/default.vue?vue&type=script&setup=true&lang.ts": () => import('./_nuxt/default.vue_vue_type_script_setup_true_lang-styles.0f6e021a.mjs').then(interopDefault)
};
